...
class DiffStat:
    ...
    def diff(self, prev_stats: dict, cur_stats: dict):
        ...
        try:
            cards_and_penalties_result = self.diff_cards_and_penalties(prev_stat=prev_stats, cur_stat=cur_stats)
            if cards_and_penalties_result:
                self.result.update({'cards_and_penalties_changed': cards_and_penalties_result})
        except Exception as err:
            print(repr(err))
            pass
        ...
        try:
            ...
            if dashboard_result:
                self.result.update({'dashboard_changes': dashboard_result})
        except Exception as err:
            print(repr(err))
            pass
        ...
        try:
            ...
            if table_result:
                self.result.update({'table_changes': table_result})
        except Exception as err:
            print(repr(err))
            pass
